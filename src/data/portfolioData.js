...
export const projects = [
  {
    number: '01', title: 'AI Notes Summarizer', eyebrow: 'AI-powered productivity application', type: 'AI Productivity Tool', date: 'June 2026', icon: Sparkles, accent: 'purple', previewStyle: 'ai-dashboard',
